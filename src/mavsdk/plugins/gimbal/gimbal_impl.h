...
public:
    ...
    void release_control_async(int32_t gimbal_id, Gimbal::ResultCallback callback);
...
private:
    ...
    void request_gimbal_manager_information(uint8_t target_component_id);
    void request_gimbal_device_information(uint8_t target_component_id);
    ...
    std::optional<GimbalAddress> maybe_address_for_gimbal_id(int32_t gimbal_id);
